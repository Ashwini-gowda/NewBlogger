...
ActiveRecord::Schema.define(version: 2019_07_23_100034) do
  ...
  create_table "articles_sub_categories", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "article_id"
    t.integer "sub_category_id"
    t.index ["article_id", "sub_category_id"], name: "index_articles_sub_categories_on_article_id_and_sub_category_id"
  end
  ...
  create_table "sub_categories", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
    t.integer "article_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
